...
from optimized.stdf_parser import scan_test_list, parse_filter_values
from optimized.guid_analysis import analyze_guid_data
...
def launch_desktop_app():
    ...
    from optimized.gui_app import STDFGuidCheckerApp
    root = tk.Tk()
