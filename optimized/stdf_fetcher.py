...
def _get_json_path(filename: str) -> str:
    """Locate external JSON/config file beside the EXE.
    ...
    Priority:
    1. Beside launched EXE
    2. Beside Python script
    """
    import os
    import sys

    # Actual launched application directory
    app_dir = os.path.dirname(os.path.abspath(sys.argv[0]))

    # External JSON beside EXE
