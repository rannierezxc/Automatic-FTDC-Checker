...
class STDFGuidCheckerApp:
    ...
    def _build_ui(self):
        ...
        self.get_ftdc_button = ttk.Button(
        ...
        self.get_stdf_button = ttk.Button(
            secondary_actions_frame,
            text="Get STDF",
            command=self.start_get_stdf,
            style="SecondaryAction.TButton",
        )
        self.get_stdf_button.grid(row=0, column=1, sticky="ew", padx=(4, 4))
        self.check_stdf_button = ttk.Button(
            secondary_actions_frame,
            text="Check STDF",
        ...
        # All primary action buttons — disabled together while any operation runs.
        self._action_buttons = [
